...
$cf7free_gs_tools_service  = new Gs_Connector_Service();
?>
...
<div class="system-statuswc">
   <div class="info-container">
      <h2 class="systemifo">System Info</h2>
        ...
        <?php echo $cf7free_gs_tools_service->get_cf7gs_system_info(); ?>
   </div>
</div>

<div class="system-Error-cf7">
    <div class="error-container">
        ...
        <?php echo $cf7free_gs_tools_service->display_error_cf7_log(); ?>
    </div>
</div>
