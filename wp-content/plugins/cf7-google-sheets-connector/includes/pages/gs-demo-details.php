		...
		<li class="content-visible">
			...
			<div class="cd-faq-content cd-faq-content5" style="display: block;">
				...
				<div class="gs-demo-fields gs-second-block">
					...
					<p>
					  <a class="cf_pro_link_buy" href="https://www.gsheetconnector.com/cf7-google-sheet-connector-pro?gsheetconnector-ref=17" target="_blank" rel="noopener">
					  	<label>
					  	<!-- <?php echo esc_html( __( 'Buy Now - $29.00', 'gsconnector' ) ); ?> -->
